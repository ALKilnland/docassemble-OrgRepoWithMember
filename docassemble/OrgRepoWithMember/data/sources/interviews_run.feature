...
@avoid
Scenario: avoid.yml runs
  Given I start the interview at "avoid.yml"
...
@chooseme
Scenario: choose_me_1.yml runs
  Given I start the interview at "choose_me_1.yml"
  #And the maximum seconds for each Step in this Scenario is 50
  #And I get to the question id "downloads" with this data:
  #  | var | value | trigger |
  #  | users[0].name.first | Uli | users[0].name.first |
...
@chooseme
Scenario: choose_me_2.yml runs
  Given I start the interview at "choose_me_2.yml"
  #And the maximum seconds for each Step in this Scenario is 50
  #And I get to the question id "downloads" with this data:
  #  | var | value | trigger |
  #  | users[0].name.first | Uli | users[0].name.first |
